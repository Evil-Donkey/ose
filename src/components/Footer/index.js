        ...
        <div className="bg-cover bg-center bg-[url('/gradient.png')] text-white pt-16">
            <Container className="mb-10 lg:mb-20">
                ...
                <div className="flex flex-row gap-x-5 justify-between items-center mb-12">
                    <div className="w-1/2">
                        <div className="w-40 lg:w-60">
                            <Link href="/" aria-label="Oxford Science Enterprises - Go to homepage"><Logo /></Link>
                        </div>
                    </div>
                    <div className="flex-row w-1/2 lg:mt-0 justify-end flex gap-x-4">
                        <div className="gap-x-4 items-center mb-5 lg:mb-0">
                            {/* <YouTube /> */}
                ...
                <div className="flex flex-row flex-wrap font-medium">
                    <div className="w-full md:w-1/2 flex flex-col lg:flex-row lg:gap-5 lg:mb-0 pe-4 lg:pe-0">
                        {/* Submit an idea */}
                    ...
                    <div className="w-full md:w-1/2 flex flex-col lg:flex-row gap-x-5 md:ps-4 lg:ps-0">
                        {/* Site map */}
                        <div className="w-full lg:w-1/3 mb-5 lg:mb-0">
                            <h2 className="text-3xl md:mb-4">OSE</h2>
                            <ul>
                        ...
                        {/* Sectors */}
                        <div className="w-full lg:w-1/3 mb-5 lg:mb-0">
                            <h2 className="text-3xl md:mb-4">Sectors</h2>
                            <ul>
                        ...
                        {/* OSE */}
                        <div className="w-full lg:w-1/3 mb-5 lg:mb-0">
                            <h2 className="text-3xl md:mb-4">More</h2>
                            <ul>
            ...
            {copyright && (
                <div className="pb-15 pt-4 lg:py-4 px-4 lg:px-10 text-xs text-center bg-blue-02">
