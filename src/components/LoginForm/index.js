        ...
        <Container className="pt-40 pb-10 2xl:pt-50 relative z-10 flex flex-col lg:flex-row justify-between gap-10">
            ...
            <div className="w-full lg:w-2/5 lg:ps-2 2xl:ps-10">
                ...
                <div className="flex flex-col gap-2 mt-8">
                    <p className="text-sm flex items-center gap-2"><Link href="/shareholder-information-signup" className="text-white underline">Request access</Link><span className="text-white">|</span><Link href="/forgot-password" className="text-white underline">Forgot password?</Link></p>
                </div>
            </div>
        </Container>
    );
