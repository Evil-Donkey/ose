...
const Faqs = ({ data }) => {
    ...
    return (
        <div id={sectionLabel ? formatSectionLabel(sectionLabel) : undefined} className="relative h-full w-full overflow-hidden faqs-section">
                    ...
                    {faqs && faqs.length > 0 && faqs.map((faq, idx) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    className={`overflow-hidden transition-all duration-300 px-7 ${isOpen ? 'max-h-1000 pt-4 pb-8' : 'max-h-0 py-0'}`}
                                    style={{}}
                                >
                                    {isOpen && (
