                        ...
                        return index === 0 ? (
                            ...
                            >
                                <div className="h-full w-full flex flex-col md:flex-row gap-4 md:gap-8 justify-between overflow-hidden rounded-xl bg-cover bg-center bg-[url('/mobile-gradient.jpg')] lg:bg-[url('/desktop-gradient.jpg')]">
                                    ...
                                    <div className="p-4 md:p-8 w-full md:w-2/5 flex flex-col gap-3 text-white">
                                        {description && <div className="text-base md:text-lg" dangerouslySetInnerHTML={{ __html: description }} />}
                                        {url && <Link href={url} target="_blank" className="text-lightblue hover:text-white uppercase text-sm mt-2 font-bold transition-colors duration-300">Read more</Link>}
                                    </div>
                                </div>
                            </div>
                        ) : (
                            ...
                            >
                                <div className="h-full w-full flex flex-col gap-8 overflow-hidden rounded-xl bg-cover bg-center bg-[url('/mobile-gradient.jpg')] lg:bg-[url('/desktop-gradient.jpg')]">
                                    <div className="flex flex-col justify-between h-full gap-4 text-white p-4 md:p-8">
                                        ...
                                        {url && <Link href={url} target="_blank" className="text-lightblue hover:text-white uppercase text-sm font-bold transition-colors duration-300">Read more</Link>}
                                    </div>
                                </div>
                            </div>
                        );
