...
const FullScreenPanel = ({ data }) => {
    ...
    return (
        <div id={sectionLabel ? formatSectionLabel(sectionLabel) : undefined} className="relative min-h-[90vh] h-full w-full overflow-hidden">
            ...
            <div className="min-h-[90vh] h-full flex flex-col justify-center">
                <Container className="py-30 md:py-25 2xl:py-45 relative z-10 text-white flex flex-col h-full">
                    <div className="flex flex-col items-center text-center w-full gap-5">
                        ...
                        {copy && <div ref={copyRef} className="w-full lg:w-3/5 xl:px-17 text-xl md:text-2xl 2xl:text-[2.5rem]/12 opacity-0 translate-y-5">
