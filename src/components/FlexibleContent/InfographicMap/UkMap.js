...
const UkMap = ({ timeline }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full relative scale-80 2xl:scale-100 origin-top">
      <div className="relative w-full lg:w-120 origin-[47%_34%]">
        <Image
      ...
      {Array.from({ length: 4 }).map((_, index) => (
        <div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 mt-55 2xl:mt-55 ms-20 2xl:ms-20 scale-0"
        >
          <Image
