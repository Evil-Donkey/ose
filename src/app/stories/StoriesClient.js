                            ...
                            {/* <Link href={`/stories/${randomizedStories[0].slug}`} className="block"> */}
                                <div className="relative overflow-hidden rounded-3xl min-h-[500px] lg:min-h-[700px] p-8 flex items-end">
                                    {randomizedStories[0].featuredImage?.node?.mediaItemUrl ? (
                                        <>
                                            <Image src={randomizedStories[0].featuredImage.node.mediaItemUrl} alt={randomizedStories[0].featuredImage.node.altText} fill className="absolute inset-0 object-cover group-hover:scale-110 transition-all duration-300" />
