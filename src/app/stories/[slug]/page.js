    ...
    <>
        <div className="relative w-full min-h-dvh h-full">
            {(backgroundImage || backgroundImageMobile) &&
                <>
                    <div className={`absolute top-0 left-0 w-full h-full bg-cover bg-center ${backgroundImageMobile ? "hidden lg:block" : ""}`} style={{ backgroundImage: `url(${proxyImageUrl(backgroundImage)})` }} />
                    {backgroundImageMobile && <div className="absolute top-0 left-0 w-full h-full bg-cover bg-center lg:hidden" style={{ backgroundImage: `url(${proxyImageUrl(backgroundImageMobile)})` }} />}
