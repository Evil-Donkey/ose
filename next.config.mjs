...
const nextConfig = {
    ...
    async redirects() {
        return [
            ...
            { source: "/investors/register", destination: "/shareholder-information", permanent: true },
            { source: "/investors/forgot", destination: "/shareholder-information", permanent: true },
